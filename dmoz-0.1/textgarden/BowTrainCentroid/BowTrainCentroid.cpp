...
int main(int argc, char* argv[]){
    ...
    Env.PrepArgs("Bag-Of-Words To Centroid-Classfier-Model", 1);
    ...
    printf("Training ...");
	PBowMd CentroidMd = TBowCentroidMd::New(BowDocBs, BowDocWgtBs, CatNm, DIdV);
    CentroidMd->Save(TFOut(OutBowMdFNm));
    printf(" Done.\n");
