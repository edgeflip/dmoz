...
TGksColor TVizMapContext::ColorPointCross = TGksColor(248, 148, 6);
TGksColor TVizMapContext::ColorSelPointCross = TGksColor(185, 74, 72);
...
void TVizMapContext::PaintPointCross(PGks Gks, const int& X, 
    ...
    if (IsCatP) {
        ...
        // draw a small circle
        const int Size = SizePointCross; //TFlt::Round(SizePointCross / 1.3);
