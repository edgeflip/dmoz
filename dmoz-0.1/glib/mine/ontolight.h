...
private:
  ...
  TInt TermTypeId;
  TStr DescStr;
  // Term Resource (RDF) and Term Internal Id (WordNet)
  TStr TermUri;
...
public:
  ...
  void PutTermUri(const TStr& _TermRes){TermUri=_TermRes;}
  TStr GetTermUri() const {return TermUri;}
...
private:
  ...
  static THash<TStr, TIntStrVPrV> WN_PartOfSpRelH; 
  static TIntStrVPrV WN_EnTermV;
  static TIntStrVPrV WN_WnTermV;
  static TStrIntH WN_WnTermIdTermIdH;
private:
  // WordNet specific
  static void WN_LoadTermsConcepts(PLwOnto& LwOnto, 
    const TStr& NrFPath, const TStr& FPartOfSpNm, 
    const int& EnLangId, const int& WnLangId);
  static void WN_LoadLinks(PLwOnto& LwOnto, 
    const int& WnLangId, const TStr& PartOfSp);
  static int WN_GetLinkIdFromType(const PLwOnto& LwOnto, 
    const TStr& LinkType, const int& WnLangId, const TStr& PartOfSp);
  static void WN_LoadIndexFile(PLwOnto& LwOnto, 
    const TStr& FNm, const int& EnLangId);
  static void WN_LoadDataFile(PLwOnto& LwOnto, 
    const TStr& FNm, const int& EnLangId, const int& WnLangId);
public:
  TLwOnto():
  ...
  static PLwOnto LoadWordNet(const TStr& FPath);
};
